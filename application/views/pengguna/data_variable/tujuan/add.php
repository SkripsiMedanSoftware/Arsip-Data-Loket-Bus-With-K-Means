<div class="box box-primary">
	...
	<form action="<?php echo base_url('data_variable/tujuan/add') ?>" method="post">
		<div class="box-body">
			<div class="col-lg-6">
				<div class="form-group">
					<label>Nama Tujuan</label>
					<input class="form-control" type="text" name="nama_tujuan" placeholder="Nama Tujuan" value="<?php echo set_value('nama_tujuan') ?>">
				...
				<div class="form-group">
					...
					<select class="form-control" name="loket">
						<?php foreach ($this->data_loket_model->list() as $value) { ?>
							<option value="<?php echo $value['id'] ?>"><?php echo $value['nama_loket'] ?></option>
						<?php } ?>
					</select>
				...
				<div class="form-group">
					<label>Bus</label>
					<select class="form-control" name="bus"></select>
