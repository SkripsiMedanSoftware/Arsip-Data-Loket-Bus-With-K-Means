<div class="box box-primary">
	...
	<form action="<?php echo base_url('data_variable/paket_option/'.$paket['id'].'/update') ?>" method="post">
		<div class="box-body">
			<div class="col-lg-6">
				<div class="form-group">
					...
					<select name="tujuan" class="form-control">
						<?php foreach ($this->data_tujuan_model->list() as $value) : ?>
							<option value="<?php echo $value['id']; ?>" <?php echo $value['id'] == $paket['tujuan']?'selected':'' ?>><?php echo $value['nama_tujuan']; ?></option>
						<?php endforeach; ?>
					</select>
				...
				<div class="form-group">
					...
					<input class="form-control" type="text" name="pengirim" placeholder="Pengirim" value="<?php echo set_value('pengirim', $paket['pengirim']) ?>">
					<?php echo form_error('pengirim', '<span class="help-block error">', '</span>'); ?>
				</div>
				<div class="form-group">
					<label>Penerima</label>
					<input class="form-control" type="text" name="penerima" placeholder="Penerima" value="<?php echo set_value('penerima', $paket['penerima']) ?>">
