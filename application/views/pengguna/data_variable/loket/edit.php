<div class="box box-primary">
	...
	<form action="<?php echo base_url('data_variable/loket_option/'.$loket['id'].'/update') ?>" method="post">
		<div class="box-body">
			<div class="col-lg-6">
				<div class="form-group">
					<label>Nama Loket</label>
					<input class="form-control" type="text" name="nama_loket" placeholder="Nama Loket" value="<?php echo set_value('nama_loket', $loket['nama_loket']) ?>">
